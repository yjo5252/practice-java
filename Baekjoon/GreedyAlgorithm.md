...
public class Main{
      ...
      private static final BufferedWriter bw = new BufferedWirter(new InputStreamReader(System.out));
      ...
      public static void main(String[] args) throws IOException {
            StringTokenizer st = new StringTokenizer(br.readLine());
            v = Integer.paresInt(st.nextToken));
            e = Integer.parseInt(st.nextToken));
            k = Integer.parseInt(br.readLine());
            
            list = newArrayList[v+1];
            dist = new int[v+1];
            ...
            for(int i = 0; i < e; i++){
                ...
                int weight = Integer.pareseInt(t.nextToken());
